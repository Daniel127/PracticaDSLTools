...
namespace UPM_IPS.DRQPJPFMAMPracticaDSLTools
{
	...
	/// </summary>
	internal partial class DRQPJPFMAMPracticaDSLToolsDocView : DRQPJPFMAMPracticaDSLToolsDocViewBase
	{
		/// <summary>
		/// Constructs a new DRQPJPFMAMPracticaDSLToolsDocView.
		/// </summary>
		public DRQPJPFMAMPracticaDSLToolsDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DRQPJPFMAMPracticaDSLToolsDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new DRQPJPFMAMPracticaDSLToolsDocView.
		/// </summary>
		protected DRQPJPFMAMPracticaDSLToolsDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			DRQPJPFMAMPracticaDSLToolsDocDataBase docData = this.DocData as DRQPJPFMAMPracticaDSLToolsDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for DRQPJPFMAMPracticaDSLToolsDocViewBase should be an DRQPJPFMAMPracticaDSLToolsDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.DRQPJPFMAMPracticaDSLToolsDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.DRQPJPFMAMPracticaDSLToolsDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.DRQPJPFMAMPracticaDSLToolsToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.DRQPJPFMAMPracticaDSLToolsToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.DRQPJPFMAMPracticaDSLToolsDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.DRQPJPFMAMPracticaDSLToolsHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.DRQPJPFMAMPracticaDSLToolsHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.DRQPJPFMAMPracticaDSLToolsHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
