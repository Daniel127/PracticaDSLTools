...
namespace UPM_IPS.DRQPJPFMAMPracticaDSLTools
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.DRQPJPFMAMPracticaDSLToolsEditorFactoryId)]
	internal partial class DRQPJPFMAMPracticaDSLToolsEditorFactory : DRQPJPFMAMPracticaDSLToolsEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new DRQPJPFMAMPracticaDSLToolsEditorFactory.
		/// </summary>
		public DRQPJPFMAMPracticaDSLToolsEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DRQPJPFMAMPracticaDSLToolsEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected DRQPJPFMAMPracticaDSLToolsEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new DRQPJPFMAMPracticaDSLToolsDocView(docData, this.ServiceProvider);
		}
	}
}
