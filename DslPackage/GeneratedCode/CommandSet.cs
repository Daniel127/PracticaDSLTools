...
namespace UPM_IPS.DRQPJPFMAMPracticaDSLTools
{
	...
	/// </summary>
	internal partial class DRQPJPFMAMPracticaDSLToolsCommandSet : DRQPJPFMAMPracticaDSLToolsCommandSetBase
	{
		/// <summary>
		/// Constructs a new DRQPJPFMAMPracticaDSLToolsCommandSet.
		/// </summary>
		public DRQPJPFMAMPracticaDSLToolsCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class DRQPJPFMAMPracticaDSLToolsCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new DRQPJPFMAMPracticaDSLToolsCommandSetBase.
		/// </summary>
		protected DRQPJPFMAMPracticaDSLToolsCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewDRQPJPFMAMPracticaDSLToolsExplorerCommand,
				typeof(DRQPJPFMAMPracticaDSLToolsEditorFactory).GUID);
		...
		{
			DRQPJPFMAMPracticaDSLToolsExplorerToolWindow explorer = this.DRQPJPFMAMPracticaDSLToolsExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected DRQPJPFMAMPracticaDSLToolsDocData CurrentDRQPJPFMAMPracticaDSLToolsDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as DRQPJPFMAMPracticaDSLToolsDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected DRQPJPFMAMPracticaDSLToolsDocView CurrentDRQPJPFMAMPracticaDSLToolsDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as DRQPJPFMAMPracticaDSLToolsDocView;
			}
		}
		...
		/// </summary>
		protected DRQPJPFMAMPracticaDSLToolsExplorerToolWindow DRQPJPFMAMPracticaDSLToolsExplorerToolWindow
		{
			get
			{
				DRQPJPFMAMPracticaDSLToolsExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(DRQPJPFMAMPracticaDSLToolsExplorerToolWindow), true) as DRQPJPFMAMPracticaDSLToolsExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				DRQPJPFMAMPracticaDSLToolsExplorerToolWindow explorerWindow = this.DRQPJPFMAMPracticaDSLToolsExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class DRQPJPFMAMPracticaDSLToolsClipboardCommandSet : DRQPJPFMAMPracticaDSLToolsClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new DRQPJPFMAMPracticaDSLToolsClipboardCommandSet.
		/// </summary>
		public DRQPJPFMAMPracticaDSLToolsClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class DRQPJPFMAMPracticaDSLToolsClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new DRQPJPFMAMPracticaDSLToolsClipboardCommandSetBase.
		/// </summary>
		protected DRQPJPFMAMPracticaDSLToolsClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
