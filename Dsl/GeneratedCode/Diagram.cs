...
namespace UPM_IPS.DRQPJPFMAMPracticaDSLTools
{
	...
	public partial class DRQPJPFMAMPracticaDSLToolsDiagram : DslDiagrams::Diagram
	{
		...
		protected override DslDiagrams::ShapeElement CreateChildShape(DslModeling::ModelElement element)
		{
			...
			{
				global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.FormaAtributo newShape = new global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.FormaAtributo(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.ClavePrimaria)
			{
				global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.FormaClavePrimaria newShape = new global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.FormaClavePrimaria(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.AtributoRelacion)
			{
				global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.FormaAtributoRelacion newShape = new global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.FormaAtributoRelacion(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.Entidad)
			{
				global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.FormaEntidad newShape = new global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.FormaEntidad(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.Relacion)
			{
				global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.FormaRelacion newShape = new global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.FormaRelacion(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
...
namespace UPM_IPS.DRQPJPFMAMPracticaDSLTools
{
		...
		internal sealed partial class FixUpDiagram : FixUpDiagramBase
		{
			...
			public override void ElementAdded(DslModeling::ElementAddedEventArgs e)
			{
				...
				{
					// Method:
					// private Microsoft.VisualStudio.Modeling.ModelElement GetParentForClavePrimaria(ClavePrimaria childElement)
					// {
					// }
					// must be implemented in a partial class of UPM_IPS.DRQPJPFMAMPracticaDSLTools.FixUpDiagram.  Given a child element,
					// this method should return the parent model element that is associated with the shape or diagram that will be the parent 
