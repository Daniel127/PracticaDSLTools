...
[module: global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1506:AvoidExcessiveClassCoupling", Scope = "type", Target = "UPM_IPS.DRQPJPFMAMPracticaDSLTools.DRQPJPFMAMPracticaDSLToolsDiagram")]

namespace UPM_IPS.DRQPJPFMAMPracticaDSLTools
{
	/// <summary>
	/// DomainClass DRQPJPFMAMPracticaDSLToolsDiagram
	/// Description for
	/// UPM_IPS.DRQPJPFMAMPracticaDSLTools.DRQPJPFMAMPracticaDSLToolsDiagram
	/// </summary>
	[DslDesign::DisplayNameResource("UPM_IPS.DRQPJPFMAMPracticaDSLTools.DRQPJPFMAMPracticaDSLToolsDiagram.DisplayName", typeof(global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.DRQPJPFMAMPracticaDSLToolsDomainModel), "UPM_IPS.DRQPJPFMAMPracticaDSLTools.GeneratedCode.DomainModelResx")]
	[DslDesign::DescriptionResource("UPM_IPS.DRQPJPFMAMPracticaDSLTools.DRQPJPFMAMPracticaDSLToolsDiagram.Description", typeof(global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.DRQPJPFMAMPracticaDSLToolsDomainModel), "UPM_IPS.DRQPJPFMAMPracticaDSLTools.GeneratedCode.DomainModelResx")]
	...
	[DslModeling::DomainObjectId("b77aa092-5f71-4dd9-9ab8-04172781139d")]
	public partial class DRQPJPFMAMPracticaDSLToolsDiagram : DslDiagrams::Diagram
	{
		...
		private static global::System.ComponentModel.ToolboxItemFilterAttribute[] toolboxFilters = new global::System.ComponentModel.ToolboxItemFilterAttribute[] {
					new global::System.ComponentModel.ToolboxItemFilterAttribute(global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.DRQPJPFMAMPracticaDSLToolsToolboxHelperBase.ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) };
		...
		protected override DslDiagrams::ShapeElement CreateChildShape(DslModeling::ModelElement element)
		{
			...
			if(element is global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.Entidad)
			{
				global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.EntidadShape newShape = new global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.EntidadShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.Relacion)
			{
				global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.RelacionShape newShape = new global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.RelacionShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.RelacionReferencesAtributoRelacion)
			{
				global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.RelacionAtributoConnector newShape = new global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.RelacionAtributoConnector(this.Partition);
				return newShape;
			}
			if(element is global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.RelacionIzquiedaReferencesEntidadDerecha)
			{
				global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.RelacionEntidadConnector newShape = new global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.RelacionEntidadConnector(this.Partition);
				return newShape;
			}
			if(element is global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.RelacionDerechaReferencesEntidadIzquierda)
			{
				global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.RelacionEntidadConnector newShape = new global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.RelacionEntidadConnector(this.Partition);
				return newShape;
			}
		...
		/// <summary>
		/// Class containing decorator path traversal methods for ClavePrimariaShape.
		/// </summary>
		internal static partial class ClavePrimariaShapeDecoratorMap
		{
			/// <summary>
			/// Event handler called when decorator initialization is complete for ClavePrimariaShape.  Adds decorator mappings for this shape or connector.
			/// </summary>
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				DslDiagrams::ShapeElement shape = (DslDiagrams::ShapeElement)sender;
		...
		/// <summary>
		/// Class containing decorator path traversal methods for AtributoRelacionShape.
		/// </summary>
		internal static partial class AtributoRelacionShapeDecoratorMap
		{
			/// <summary>
			/// Event handler called when decorator initialization is complete for AtributoRelacionShape.  Adds decorator mappings for this shape or connector.
			/// </summary>
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				DslDiagrams::ShapeElement shape = (DslDiagrams::ShapeElement)sender;
		...
		private global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.RelacionAtributoConnectAction relacionAtributoConnectAction;
		private global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.RelacionEntidadIzquierdaConnectAction relacionEntidadIzquierdaConnectAction;
		private global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.RelacionEntidadDerechaConnectAction relacionEntidadDerechaConnectAction;
		/// <summary>
		...
		public override void OnViewMouseEnter(DslDiagrams::DiagramPointEventArgs pointArgs)
		{
			...
			if(activeView != null)
			{
				...
				if (SelectedToolboxItemSupportsFilterString(activeView, global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.DRQPJPFMAMPracticaDSLToolsToolboxHelper.RelacionAtributoFilterString))
				{
					if (this.relacionAtributoConnectAction == null)
					{
						this.relacionAtributoConnectAction = new global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.RelacionAtributoConnectAction(this);
						this.relacionAtributoConnectAction.MouseActionDeactivated += new DslDiagrams::MouseAction.MouseActionDeactivatedEventHandler(OnConnectActionDeactivated);
					}
					action = this.relacionAtributoConnectAction;
				} 
				else if (SelectedToolboxItemSupportsFilterString(activeView, global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.DRQPJPFMAMPracticaDSLToolsToolboxHelper.RelacionEntidadIzquierdaFilterString))
				{
					if (this.relacionEntidadIzquierdaConnectAction == null)
					{
						this.relacionEntidadIzquierdaConnectAction = new global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.RelacionEntidadIzquierdaConnectAction(this);
						this.relacionEntidadIzquierdaConnectAction.MouseActionDeactivated += new DslDiagrams::MouseAction.MouseActionDeactivatedEventHandler(OnConnectActionDeactivated);
					}
					action = this.relacionEntidadIzquierdaConnectAction;
				} 
				else if (SelectedToolboxItemSupportsFilterString(activeView, global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.DRQPJPFMAMPracticaDSLToolsToolboxHelper.RelacionEntidadDerechaFilterString))
				{
					if (this.relacionEntidadDerechaConnectAction == null)
					{
						this.relacionEntidadDerechaConnectAction = new global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.RelacionEntidadDerechaConnectAction(this);
						this.relacionEntidadDerechaConnectAction.MouseActionDeactivated += new DslDiagrams::MouseAction.MouseActionDeactivatedEventHandler(OnConnectActionDeactivated);
					}
					action = this.relacionEntidadDerechaConnectAction;
				} 
				else
				{
					action = null;
		...
		protected override void Dispose(bool disposing)
		{
			try
			{
				if(disposing)
				{
					if(this.relacionAtributoConnectAction != null)
					{
						this.relacionAtributoConnectAction.Dispose();
						this.relacionAtributoConnectAction = null;
					}
					if(this.relacionEntidadIzquierdaConnectAction != null)
					{
						this.relacionEntidadIzquierdaConnectAction.Dispose();
						this.relacionEntidadIzquierdaConnectAction = null;
					}
					if(this.relacionEntidadDerechaConnectAction != null)
					{
						this.relacionEntidadDerechaConnectAction.Dispose();
						this.relacionEntidadDerechaConnectAction = null;
					}
				}
			}
			finally
		...
		/// <summary>
		/// DRQPJPFMAMPracticaDSLToolsDiagram domain class Id.
		/// </summary>
		public static readonly new global::System.Guid DomainClassId = new global::System.Guid(0xb77aa092, 0x5f71, 0x4dd9, 0x9a, 0xb8, 0x04, 0x17, 0x27, 0x81, 0x13, 0x9d);
		/// <summary>
		/// Constructor
		/// </summary>
		/// <param name="store">Store where new element is to be created.</param>
		/// <param name="propertyAssignments">List of domain property id/value pairs to set once the element is created.</param>
		public DRQPJPFMAMPracticaDSLToolsDiagram(DslModeling::Store store, params DslModeling::PropertyAssignment[] propertyAssignments)
		...
		/// <param name="propertyAssignments">List of domain property id/value pairs to set once the element is created.</param>
		public DRQPJPFMAMPracticaDSLToolsDiagram(DslModeling::Partition partition, params DslModeling::PropertyAssignment[] propertyAssignments)
...
namespace UPM_IPS.DRQPJPFMAMPracticaDSLTools
{
		...
		[DslModeling::RuleOn(typeof(global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.RelacionIzquiedaReferencesEntidadDerecha), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddConnectionRulePriority, InitiallyDisabled=true)]
		[DslModeling::RuleOn(typeof(global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.RelacionDerechaReferencesEntidadIzquierda), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddConnectionRulePriority, InitiallyDisabled=true)]
		internal sealed partial class FixUpDiagram : FixUpDiagramBase
		{
			...
			public override void ElementAdded(DslModeling::ElementAddedEventArgs e)
			{
				...
				{
					parentElement = GetParentForEntidad((global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.Entidad)childElement);
				} else
				if(childElement is global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.Relacion)
				{
					parentElement = GetParentForRelacion((global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.Relacion)childElement);
				} else
				{
					parentElement = null;
				}
			...
			public static global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.Tapiz GetParentForEntidad( global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.Entidad root )
			{
				// Segments 0 and 1
			...
			public static global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.Tapiz GetParentForClavePrimaria( global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.ClavePrimaria root )
			{
				// Segments 0 and 1
				global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.Entidad root2 = root.Entidad;
				if ( root2 == null ) return null;
			...
			public static global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.Tapiz GetParentForAtributoRelacion( global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.AtributoRelacion root )
			{
				// Segments 0 and 1
				global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.Tapiz result = root.Tapiz;
				if ( result == null ) return null;
			...
			public static global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.Tapiz GetParentForRelacion( global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.Relacion root )
			{
				// Segments 0 and 1
				global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.Tapiz result = root.Tapiz;
				if ( result == null ) return null;
		...
		internal sealed class DecoratorPropertyChanged : DslModeling::ChangeRule
		{
			...
			public override void ElementPropertyChanged(DslModeling::ElementPropertyChangedEventArgs e)
			{
				...
				if (e.DomainProperty.Id == global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.Relacion.CardinalidadIzquierdaDomainPropertyId)
				{
					DslDiagrams::Decorator decorator = global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.RelacionShape.FindRelacionShapeDecorator("CardinalidadIzqDecorator");
					if(decorator != null)
					{
				...
				{
					DslDiagrams::Decorator decorator = global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.RelacionShape.FindRelacionShapeDecorator("CardinalidadDerDecorator");
					if(decorator != null)
					{
						decorator.UpdateDecoratorHostShapes(e.ModelElement, global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.Relacion.DomainClassId);
					}
		...
		internal sealed class ConnectorRolePlayerChanged : DslModeling::RolePlayerChangeRule
		{
			...
			public override void RolePlayerChanged(DslModeling::RolePlayerChangedEventArgs e)
			{
				...
				foreach (DslDiagrams::PresentationViewsSubject connectorLink in connectorLinks)
				{
					...
					if (linkShape != null)
					{
						global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.DRQPJPFMAMPracticaDSLToolsDiagram diagram = linkShape.Diagram as global::UPM_IPS.DRQPJPFMAMPracticaDSLTools.DRQPJPFMAMPracticaDSLToolsDiagram;
						if (diagram != null)
						{
