...
namespace UPM_IPS.DRQPJPFMAMPracticaDSLTools
{
	...
	/// </remarks>
	public partial class DRQPJPFMAMPracticaDSLToolsHelpKeywordHelper : DRQPJPFMAMPracticaDSLToolsHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new DRQPJPFMAMPracticaDSLToolsHelpKeywordHelper.
		/// </summary>
		protected DRQPJPFMAMPracticaDSLToolsHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the DRQPJPFMAMPracticaDSLToolsHelpKeywordHelper.
		/// </summary>
		public static DRQPJPFMAMPracticaDSLToolsHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class DRQPJPFMAMPracticaDSLToolsHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new DRQPJPFMAMPracticaDSLToolsHelpKeywordHelperBase.
		/// </summary>
		protected DRQPJPFMAMPracticaDSLToolsHelpKeywordHelperBase()
			: base() { }
